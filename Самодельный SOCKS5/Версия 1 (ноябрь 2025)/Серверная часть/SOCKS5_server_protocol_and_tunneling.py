...
class ProtocolHandler:
    ...
    # Удаляем метод аутентификации клиента по токену
    ...
    # 1. Аутентификация клиента по логину и паролю (стандартная SOCKS5 аутентификация).
    # 2. Negotiation методы (no auth или username/password).
    ...
    def handle_handshake(self, client_sock: socket.socket) -> Optional[socket.socket]:
        ...
        try:
            ...
            # Удаляем аутентификацию по токену
